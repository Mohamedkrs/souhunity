...
public class MazeGenerator {
	...
	public void GenerateMaze ()
	{
		...
		while (mCellsToVisit.Count > 0) {
			...
			//This is to set our gol qt the end of the maze	
			if (ctv.Row == RowCount - 1 && ctv.Column == ColumnCount - 1) {
				GetMazeCell (ctv.Row, ctv.Column).IsGoal = true;
						// GetMazeCell(1, 0).WallBack = true; 
						GetMazeCell(ctv.Row, ctv.Column).WallFront = false; 
						// GetMazeCell(1, 0).WallLeft = true; 
