...
namespace UnityStandardAssets.CrossPlatformInput
{
    ...
    public class JumperTiltInput : MonoBehaviour
    {
        ...
        private JumperCrossPlatformInputManager.VirtualAxis m_SteerAxis;
        ...
        private void OnEnable()
        {
            ...
            {
                m_SteerAxis = new JumperCrossPlatformInputManager.VirtualAxis(mapping.axisName);
                JumperCrossPlatformInputManager.RegisterVirtualAxis(m_SteerAxis);
            }
        }
        ...
        private void Update()
        {
            ...
            switch (mapping.type)
            {
                ...
                case AxisMapping.MappingType.MousePositionX:
                    JumperCrossPlatformInputManager.SetVirtualMousePositionX(axisValue*Screen.width);
                    break;
                case AxisMapping.MappingType.MousePositionY:
                    JumperCrossPlatformInputManager.SetVirtualMousePositionY(axisValue*Screen.width);
                    break;
                case AxisMapping.MappingType.MousePositionZ:
                    JumperCrossPlatformInputManager.SetVirtualMousePositionZ(axisValue*Screen.width);
                    break;
            }
        }
...
{
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof (JumperTiltInput.AxisMapping))]
